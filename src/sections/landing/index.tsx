...
const LandingSection = () => {
  return (
    <section
      id="home"
      className="w-full min-h-screen h-auto relative overflow-clip pb-20 pt-10"
    >
      ...
      <Container className="pt-20 md:pt-[170px] relative z-10">
        <div className="flex flex-col gap-3 items-center text-center">
          <Fade cascade damping={0.1} triggerOnce>
            ...
            <h3 className="opacity-70 font-light max-w-[500px] xl:max-w-[640px] mt-4 xl:mt-6">
              ...
              — with a strong focus on component architecture, UI & UX design,
              and clean, maintainable code that supports fast development and
              seamless user experiences.
            </h3>
          </Fade>

          {/* Contact */}
          <div className="w-full flex flex-col items-center gap-4 mt-[100px] md:w-auto md:flex-row rounded-2xl">
